...
{
    public AnalysisParseResult ParseAnalysis(string jsonResponse)
    {
    ...
    public AnalysisResult? TryParseAnalysis(string jsonResponse)
    {
        int jsonStartIndex = jsonResponse.IndexOf('{');
    ...
    public StructureParseResult ParseStructure(string jsonResponse, double duration)
    {
        try
        {
